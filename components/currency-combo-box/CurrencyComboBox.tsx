...
import SkeletonWrapper from '../skeleton-wrapper/SkeletonWrapper';
      ...
      <SkeletonWrapper isLoading={userSettings.isFetching}>
        <Popover open={open} onOpenChange={setOpen}>
          ...
          <PopoverContent className="w-[200px] p-0" align="start">
            <OptionList setOpen={setOpen} setSelectedOption={selectOption} selectedOption={selectedOption} />
          </PopoverContent>
        </Popover>
      </SkeletonWrapper>
    );
        ...
        <CommandGroup>
          {Currencies.map((currency) => (
            <CommandItem
              ...
              className={cn(selectedOption?.value === currency.value && 'text-primary')}
